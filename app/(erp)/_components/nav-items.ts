export interface NavItem {
  label: string;
  icon: "home" | "orders" | "returns" | "recovery" | "customers" | "inventory" | "procurement" | "support" | "finance" | "analytics" | "team" | "onboarding" | "attendance" | "tasks" | "audit" | "settings";
  href: string;
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Procurement", icon: "procurement", href: "/procurement", permission: "procurement.view" },
  ...
  { label: "Onboarding", icon: "onboarding", href: "/onboarding", permission: ["team.manage", "onboarding.view"] },
  { label: "Attendance", icon: "attendance", href: "/attendance", permission: "attendance.view" },
  { label: "Tasks", icon: "tasks", href: "/tasks", permission: "tasks.view" },
